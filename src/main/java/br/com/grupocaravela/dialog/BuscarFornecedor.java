...
public class BuscarFornecedor extends JDialog {
	...
	public static void main(String[] args) {
		try {
			BuscarFornecedor dialog = new BuscarFornecedor();
	...
	public BuscarFornecedor() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(BuscarFornecedor.class.getResource("/br/com/grupocaravela/icones/logoCaravela.png")));
		setTitle("Busca de fornecedors");
		setAlwaysOnTop(true);
	...
	private void criarJanela() {
		...
		button_1.setIcon(
				new ImageIcon(BuscarFornecedor.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
		...
		button_2.setIcon(new ImageIcon(BuscarFornecedor.class.getResource("/br/com/grupocaravela/icones/aprovar_24.png")));
	...
	private void carregarTableModel() {
		...
		this.table.setModel(tableModelFornecedor);
/*
		// Render de Moeda
...
*/
			...
			public void run() {
				...
				try {
					...
					Query consulta = manager
							.createQuery("from Fornecedor where razao_social like '%" + tfLocalizar.getText() + "%' OR fantasia like '%" + tfLocalizar.getText() + "%' ORDER BY razao_social ASC");
	...
	private void importar() {
		fornecedor = tableModelFornecedor.getFornecedor(table.getSelectedRow());
