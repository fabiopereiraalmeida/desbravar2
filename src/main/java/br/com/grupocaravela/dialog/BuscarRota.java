...
public class BuscarRota extends JDialog {
	...
	public static void main(String[] args) {
		try {
			BuscarRota dialog = new BuscarRota();
	...
	public BuscarRota() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(BuscarRota.class.getResource("/br/com/grupocaravela/icones/logoCaravela.png")));
		setTitle("Busca de rotas");
		setAlwaysOnTop(true);
	...
	private void criarJanela() {
		...
		button_1.setIcon(
				new ImageIcon(BuscarRota.class.getResource("/br/com/grupocaravela/icones/alerta_amarelo_24.png")));
		...
		button_2.setIcon(new ImageIcon(BuscarRota.class.getResource("/br/com/grupocaravela/icones/aprovar_24.png")));
	...
	private void carregarTableModel() {
		...
		this.table.setModel(tableModelRota);
	...
	private void importar() {
		rota = tableModelRota.getRota(table.getSelectedRow());
		idRota = rota.getId();
		dispose();
	}
